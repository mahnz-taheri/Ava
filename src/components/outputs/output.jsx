...
const Output = ({ currentTab, text, timeText, paused, audioRef, duration, language, setPaused, setIsFetch,}) => {
    ...
    >
      <div className="output-top">
        <div className="top-left">
          <div
            className={
              currentTab === "record"
                ? "top-left-restart restart-record"
                : currentTab === "upload"
                ? "top-left-restart restart-upload"
                : currentTab === "link"
                ? "top-left-restart restart-link"
                : ""
            }
      ...
      <div className="output-center">
        {activeText === 1 ? (
          ...
          <TimedText paused={paused} timeText={timeText} />
        )}
      </div>
      {/*voice output */}
